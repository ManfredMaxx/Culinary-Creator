  ...
  if (!user) {
    return (
      <div className="container max-w-6xl mx-auto py-16 px-4 text-center">
        ...
        <h1 className="text-2xl font-bold font-playfair mb-4">Sign In Required</h1>
        <p className="text-muted-foreground mb-6">
          Please sign in to see recipes from chefs you follow.
        </p>
        <Button asChild>
  ...
  return (
    <div className="container max-w-6xl mx-auto py-8 px-4">
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          <h1 className="text-3xl font-bold font-playfair">My Chefs</h1>
          <p className="text-muted-foreground">Recipes from chefs you follow</p>
        </div>
      </div>
